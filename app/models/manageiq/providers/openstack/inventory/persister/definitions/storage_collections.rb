module ManageIQ::Providers::Openstack::Inventory::Persister::Definitions::StorageCollections
  ...
  def initialize_cinder_inventory_collections
    add_cinder_collection(:cloud_volumes)
    add_cinder_collection(:cloud_volume_snapshots)
    add_cinder_collection(:cloud_volume_types)
  ...
  def initialize_swift_inventory_collections
    add_swift_collection(:cloud_object_store_objects)
    add_swift_collection(:cloud_object_store_containers)
